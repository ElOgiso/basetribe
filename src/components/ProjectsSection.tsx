  ...
  const projects = [
    {
      ...
      status: 'live',
      description: 'A comprehensive community engagement platform for the base ecosystem. Features include real-time engagement tracking, token rewards ($BTRIBE),$JESS and $USDC, leaderboard systems, NFT minting, and seamless Web3 integration with Base Account and Farcaster protocols.',
      link: null,
      version: 'Beta',
      icon: '🏆',
    },
